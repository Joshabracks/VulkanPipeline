...
VkExtent2D Pipeline::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
...
SwapChainSupportDetails Pipeline::querySwapChainSupport(VkPhysicalDevice device) {
